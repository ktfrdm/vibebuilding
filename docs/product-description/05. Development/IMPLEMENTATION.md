...
- Участник нажал «Готово» (выбрал слоты) → организатор получает уведомление и ссылку на сводку.
- Участник нажал «Увы, не смогу» → организатор получает уведомление.
- Участник ответил «Да, приду!» или «Увы, не смогу» на «Сможешь прийти?» → организатор получает уведомление.
