...
- **[GITHUB_SETUP.md](./instructions/GITHUB_SETUP.md)** - Инструкция по подключению GitHub и настройке релизов
- **[GITHUB_COMMIT_INSTRUCTION.md](./instructions/GITHUB_COMMIT_INSTRUCTION.md)** - Инструкция по коммитам
...
3. **Ознакомьтесь с [USER_STORIES.md](./product-description/USER_STORIES.md)** - чтобы понять потребности пользователей
